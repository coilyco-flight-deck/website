...
{% section { id: "stack", extraClass: "project__chain", band: "penumbra", accent: "context", label: "One boundary, three proofs", heading: "The whole reviewable surface is one file a person can read." } %}
{% set here = "mcp-beaver" %}
